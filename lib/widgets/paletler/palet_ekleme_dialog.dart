...
class PaletEkleDialogum extends StatefulWidget {
  @override
  _PaletEkleDialogumState createState() => _PaletEkleDialogumState();
}

class _PaletEkleDialogumState extends State<PaletEkleDialogum> {
  final muglaBeyazUrl =
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, PaletlerViewModel _viewModel, widget) => Theme(
        data: ThemeData(
                              ...
                              onPressed: () {
                                ...
                                if (_fKey.currentState.validate()) {
                                  Future.delayed(Duration(seconds: 4), () {
                                    ...
                                    _viewModel.addPaletView(Paletler(
                                        ...
                                        _resimUrl));
                                    (_viewModel.state ==
                                            PaletlerState.LoadedState)
                                        ? veriGeldi()
                                        //Ana sayfa geri yüklendiği için direk GetData methodu tetikleniyor.
                                        : (_viewModel.state ==
                                                PaletlerState.LoadingState)
                                            ? veriGeliyor()
                                            : (_viewModel.state ==
                                                    PaletlerState.ErrorState)
                                                ? hataGeldi()
                                                : Text("Seçim");
                                  });
                                }
