...
class IdSorguileGelenPaletler extends StatelessWidget {
  String secilenId;
  IdSorguileGelenPaletler({@required this.secilenId});
  @override
  Widget build(BuildContext context) {
    ...
    return Consumer(
      builder: (context, PaletlerViewModel _viewModel, widget) => FutureBuilder(
          future: _viewModel.paletlerGetQueryWithIdView(secilenId),
