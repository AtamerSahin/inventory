...
class SorguileGelenPaletler extends StatelessWidget {
  String secilenIsim;
  SorguileGelenPaletler({@required this.secilenIsim});
  @override
  Widget build(BuildContext context) {
    ...
    return Consumer(
      builder: (context, PaletlerViewModel _viewModel, widget) => FutureBuilder(
          future: _viewModel.paletlerGetQueryWithNameView(secilenIsim),
